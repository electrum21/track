...
public class DocumentService {
    ...
    private String buildTaskPrompt(String weekContext) {
        ...
        return "Extract all assignments, projects, quizzes, and exams from this document.\n"
            ...
            + "Some modules are codeshared/cross-listed under multiple codes for the same class "
            + "(e.g. \"SC2008/CE2008/CZ2008\"). If a code appears this way, keep ALL of them joined "
            + "by \"/\" in moduleCode exactly as shown — do not collapse it down to a single code.\n"
            + "Return a JSON array where each object has:\n"
            + "- title (string)\n"
            + "- moduleCode (string, or null — may be multiple codeshared codes joined by \"/\")\n"
    ...
    private String buildCourseAndTaskPrompt(String weekContext) {
        ...
        return "Extract course information and all assessed tasks from this document.\n"
            ...
            + "  - moduleCode (required, skip if unknown — may be multiple codeshared codes joined by \"/\")\n"
            ...
            + "  - title (string)\n"
            + "  - moduleCode (string matching a course code above, or null — may be multiple codeshared codes joined by \"/\")\n"
            + "  - type (ASSIGNMENT, PROJECT, EXAM, or QUIZ)\n"
